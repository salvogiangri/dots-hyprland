...
for i in ags fontconfig foot fuzzel hypr mpv wlogout rubyshot
...
v yay -Rns illogical-impulse-{agsv1,audio,backlight,basic,fonts-themes,gnome,gtk,hyprland,microtex-git,oneui4-icons-git,portal,python,screencapture,widgets} plasma-browser-integration
