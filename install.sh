...
v gsettings set org.gnome.desktop.interface font-name 'SF Pro Display 11'
...
# MISC (For .config/* but not Hyprland)
case $SKIP_MISCCONF in
  true) sleep 0;;
  *)
    for i in $(find .config/ -mindepth 1 -maxdepth 1 ! -name 'hypr' -exec basename {} \;); do
#      i=".config/$i"
